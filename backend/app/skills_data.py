...
SKILL_DICTIONARY = {
    ...
    "Node.js": ("tool", ["node", "nodejs", "node.js", "express", "expressjs", "express.js"]),
    ...
    "Linux": ("technical", ["linux", "unix"]),
    "REST APIs": ("technical", ["rest", "rest api", "rest apis", "restful", "api development"]),
    ...
    "CompTIA Security+": ("certification", ["security+", "comptia security+", "comptia"]),
    ...
    "Estimation & Costing": ("technical", ["estimation", "costing", "cost estimation", "quantity surveying"]),
    ...
    "Taxation": ("technical", ["taxation", "tax", "income tax", "tax returns"]),
...
ROLES = {
    ...
    "UI/UX Designer": {
        ...
        "advanced": ["HTML", "CSS", "Communication", "Teamwork"],
    },
    "DevOps Engineer": {
...
ROLE_CERTIFICATIONS = {
    ...
    "UI/UX Designer": ["Google UX Design Certificate"],
    "DevOps Engineer": ["AWS Certified Cloud Practitioner"],
    "Cloud Engineer": ["AWS Certified Cloud Practitioner"],
    "QA / Test Engineer": ["ISTQB Certified Tester Foundation Level"],
